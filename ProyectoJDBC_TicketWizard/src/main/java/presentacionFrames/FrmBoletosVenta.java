...
public class FrmBoletosVenta extends javax.swing.JFrame {
     ...
     */
    public FrmBoletosVenta(Usuario usuarioLoggeado) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBoletosVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBoletosVenta().setVisible(true);
            }
        });
    }
